...
/**
 * This script defines class for php unit test case of class \PF\Main\Event\Listener\Once.
 *
 * @author     Martin Kovar
...
class OnceTest extends TestCase {
    ...
    protected function setUp() {
        $this->_listener = $this->getProvider()->prototype('PF\Main\Event\Listener\Once');
    ...
    public function testSetClosure() {
        $closure  = function () {};
        $this->assertInstanceOf('PF\Main\Event\Listener\Once', $this->_listener->setClosure($closure));
    ...
    public function testSetModule() {
        $this->assertInstanceOf('PF\Main\Event\Listener\Once', $this->_listener->setModule('Module'));
    ...
    public function testSetName() {
        $this->assertInstanceOf('PF\Main\Event\Listener\Once', $this->_listener->setName('test'));
